...
//declare all static data here------------------------------------	
	static String name = "patient";
	static String eye = "left";
...
//Generic window making---------------------------------------------------------------------------------
	...
	backgroundColor= (int) gd.getNextNumber();
//------------------------------------------------------------------------------------------------------------------
...
ImagePlus im = NewImage.createImage(
 name+" "+eye+"eye", (int)width, (int)height, 1,8, NewImage.FILL_BLACK);
...
//making center mark(cross) for fixation------------------------------------------------------------------
//ip.putPixel(width/2,height/2,255);
for(int i=0;i<10;i++){
ip.putPixel((int)width/2-i,(int)height/2+i,255);
ip.putPixel((int)width/2+i,(int)height/2+i,255);
ip.putPixel((int)width/2-i,(int)height/2-i,255);
ip.putPixel((int)width/2+i,(int)height/2-i,255);
}

//displaying the blind spot for fixation----------------------------------------------------------------------
BlindSpot blind = new BlindSpot(eye);				//creating the blind spot..............
ip.snapshot();	
ip.setColor(255);
